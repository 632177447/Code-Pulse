...
impl Default for ContextRequest {
    fn default() -> Self {
        Self {
            ...
            included_types: vec![
                "vue".to_string(), "ts".to_string(), "tsx".to_string(), "js".to_string(), "mjs".to_string(), 
                "rs".to_string(), "py".to_string(), "go".to_string(), "java".to_string(), "kt".to_string(), 
                "cpp".to_string(), "c".to_string(), "h".to_string(), "cs".to_string(), "php".to_string(), 
                "rb".to_string(), "json".to_string(), "md".to_string(), "html".to_string(), "css".to_string(), 
                "scss".to_string(), "less".to_string()
            ],
